...
get_required_kitsune_lib_repo "libKitsunemimiSakuraDatabase" "v0.6.1" 8
get_required_kitsune_lib_repo "libKitsunemimiSakuraHardware" "v0.2.0" 8
echo ""
echo "###########################################################################################################"
echo ""
...
echo "###########################################################################################################"
echo ""
get_required_kitsune_lib_repo "libAzukiHeart" "v0.3.0" 8
get_required_kitsune_lib_repo "libMisakiGuard" "v0.2.0" 8
echo ""
echo "###########################################################################################################"
